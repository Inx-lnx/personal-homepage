...
{id:"plan",ask:"你接下来打算做什么？",keys:["下一步","接下来打算","接下来打算做什么","打算做什么","打算","计划","目标","以后想","未来","以后想做什么","高数"],answer:"现在主要在忙三件事：高数、英语和 AI 应用。高数是必修课，躲不掉；英语是为了以后出国读书；AI 应用是最想做下去的方向。先把这三样学明白，再说别的。",followups:["你最近在做什么？","网站还会更新吗？","你的学习经历是怎样的？"]},
{id:"english",ask:"你为什么学英语？",keys:["为什么学英语","英语","背单词","四级","六级","外语","english"],answer:"为了以后出国读书。另外很多文档、论文和项目说明都是英文写的，练到能自己看懂，就不用总等别人翻译。",followups:["你最近在做什么？","你接下来打算做什么？","你的技能怎么样？"]},
