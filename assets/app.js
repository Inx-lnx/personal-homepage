...
{id:"real",ask:"你是真人吗？",keys:["你是真人吗","你是人吗","你是不是人","你是ai吗","你是不是ai","你是机器人吗","你是程序吗","你是数字人吗","你是假的吗"],answer:"我是数字分身，是崇施涵用一页本地知识库手搓出来的「嘴替」——不联网，也不偷偷记下你问了什么。真人版得靠他自己回你消息。",followups:["你是谁？","这网站怎么做出来的？","怎么联系你？"]},
{id:"school",ask:"你在哪个学校？",keys:["学校","哪个大学","在哪读书","读哪个学校","哪个学校","天大","天津大学"],answer:"天津大学，学的是计算机。校区就在天津，风大是真的，但该写的代码一行都不会少。",followups:["你在学什么？","你在哪个城市？","你最近在做什么？"]},
...
{id:"major",ask:"你在学什么？",keys:["学什么","学的是","专业","课程","在学","学的啥","学哪些","学什么专业"],answer:"计算机方向，主攻 AI 应用。现在手上的组合是 HTML / CSS、JavaScript、Python 和 Supabase——每样都还在「会用」通往「用得溜」的路上。",followups:["你的技能怎么样？","你最近在做什么？","你还做过什么？"]},
...
/* ---------- 兴趣与生活 ---------- */
{id:"hobby",ask:"你有什么兴趣？",keys:["兴趣","爱好","喜欢什么","平时喜欢","喜欢干什么","玩什么"],answer:"音乐、羽毛球、二次元三件套。翻译一下就是：一边听歌一边打球，打完回家看番——体力活和脑力活轮着来。",followups:["你喜欢听什么音乐？","你打羽毛球厉害吗？","你喜欢哪些番？"]},
{id:"music",ask:"你喜欢听什么音乐？",keys:["听什么歌","听什么音乐","喜欢听","歌单","歌手","音乐口味","喜欢音乐","音乐"],answer:"安静和抒情的曲子听得多，所以这站的背景音乐是慢速钢琴 + 小提琴——写代码时当背景，不抢注意力那种。",followups:["背景音乐是哪来的？","你有什么兴趣？","你平时都在干嘛？"]},
{id:"badminton",ask:"你打羽毛球厉害吗？",keys:["羽毛球","打球","运动","体育","球技"],answer:"羽毛球属于「快乐第一、胜负随缘」的水平：跑得动、接得住，偶尔还能打出一拍自己都想鼓掌的球。想约球也行，前提是你别太强。",followups:["你有什么兴趣？","怎么联系你？","你在哪个城市？"]},
{id:"acg",ask:"你喜欢哪些番？",keys:["哪些番","喜欢哪些番","二次元","动漫","番剧","追番","看番","动画","游戏"],answer:"二次元是日常续命方式之一，番剧和游戏都沾一点。具体片单就不剧透了——这种东西各人口味不同，聊起来才有意思。",followups:["你有什么兴趣？","你喜欢听什么音乐？","你平时都在干嘛？"]},
...
{id:"plan",ask:"你接下来打算做什么？",keys:["下一步","接下来打算","接下来打算做什么","打算做什么","打算","计划","目标","以后想","未来","以后想做什么"],answer:"短期是把主页和数字分身继续做扎实、把英语提上去；中期想做出一个真正有完整功能的 AI 应用。目标不虚，就是得一行行敲出来。",followups:["你最近在做什么？","网站还会更新吗？","你的学习经历是怎样的？"]},
...
{id:"tools",ask:"你用什么工具写代码？",keys:["用什么工具","编辑器","ide","vscode","写代码用什么","开发环境"],answer:"主力是 VS Code，再配上一堆 AI 助手当搭子。工具不花哨，够用就行——毕竟换个编辑器也不会让代码自己变好。",followups:["你怎么看 AI？","你的技能怎么样？","能帮我做一个吗？"]},
/* ---------- 联系方式 ---------- */
