...
{id:"school",ask:"你在哪个学校？",keys:["学校","哪个大学","在哪读书","读哪个学校","哪个学校","天大","天津大学"],answer:"天津大学，计算机科学与技术专业，平时在深圳学习。课表该有的都有，代码一行都不会少。",followups:["你在学什么？","你在哪个城市？","你最近在做什么？"]},
{id:"city",ask:"你在哪个城市？",keys:["哪个城市","在哪座城市","你在哪里","深圳吗","深圳","天津吗","哪个地方"],answer:"我在深圳学习，学校是天津大学（在天津）。所以天津的风和深圳的天气，我都能聊上一点。",followups:["你在哪个学校？","你最近在做什么？","你有什么兴趣？"]},
...
{id:"recent",ask:"你最近在做什么？",keys:["最近","在做什么","在忙","忙什么","最近在忙","最近怎么样","最近好吗","近来","干嘛呢"],answer:"最近主要忙三件事：高数、英语和 AI 应用——主页也在持续迭代（从 V1 折腾到现在）。作息挺随性，看当天状态安排，反正三头都想抓。",followups:["这网站怎么做出来的？","你的技能怎么样？","你接下来打算做什么？"]},
...
/* ---------- 作品与这站 ---------- */
{id:"project",ask:"你还做过什么？",keys:["做过什么","作品","项目","做过哪些","做过什么项目","写过什么","你的作品"],answer:"这个项目里有四件真做出来的东西：个人主页本身（纯手写 HTML / CSS / JS，从 V1 迭代到现在）、数字分身、Supabase 反馈系统，还有一首原创背景音乐。下一个想做的还在攒想法。",followups:["这网站怎么做出来的？","你接下来打算做什么？","你的技能怎么样？"]},
...
{id:"update",ask:"网站还会更新吗？",keys:["还会更新","下一版","更新吗","以后会","下个版本","新版","v4","第几版","几个版本"],answer:"会，这站是「持续生长」型的：从 V1 到 V4 已经比第一版胖了好几圈，下一步想继续扩充数字分身的内容、再打磨交互细节。有想法随时用页面底部的反馈表单丢给我。",followups:["这网站怎么做出来的？","我可以给你反馈吗？","你接下来打算做什么？"]},
{id:"help",ask:"能帮我做一个网站吗？",keys:["帮我做","能不能做","接单","帮我写","给我做一个","教我做一个","帮我也做"],answer:"当然可以聊！先说说你想做什么样的站——个人展示、作品集还是别的？我能帮你理清需要哪几块内容、用什么方式做最省事，也能帮你搭一个简单页面的骨架。我强在前端，太复杂的后端得一起想办法。发邮件到 sora291933347@tju.edu.cn 就行。",followups:["怎么联系你？","你用什么工具写代码？","这网站怎么做出来的？"]},
...
/* ---------- 兴趣与生活 ---------- */
{id:"hobby",ask:"你有什么兴趣？",keys:["兴趣","爱好","喜欢什么","平时喜欢","喜欢干什么","玩什么"],answer:"音乐、羽毛球、二次元，最近又添了围棋。翻译一下就是：一边听歌一边打球，打完回家看番，闲下来再摆一局棋——体力、脑力、耐心轮着来。",followups:["你喜欢听什么音乐？","你打羽毛球吗？","你喜欢哪些番？"]},
...
{id:"go",ask:"你会下围棋吗？",keys:["围棋","下棋","棋类","棋力","会不会下棋"],answer:"围棋是最近加进生活的一项爱好：安安静静坐下来想几步棋，正好平衡平时写代码的节奏。水平一般，但下棋时那种专注我很喜欢。",followups:["你有什么兴趣？","你平时怎么放松？","你平时都在干嘛？"]},
...
{id:"daily",ask:"你平时都在干嘛？",keys:["平时","日常","一天","生活","空闲","闲下来"],answer:"作息挺随性，看当天状态安排：课多就上课，状态好就写代码，状态差就听歌看番。偶尔也会像现在这样——花一晚上给主页加个聊天框，然后觉得「还挺值」。",followups:["你最近在做什么？","你有什么兴趣？","你接下来打算做什么？"]},
...
{id:"plan",ask:"你接下来打算做什么？",keys:["下一步","接下来打算","接下来打算做什么","打算做什么","打算","计划","目标","以后想","未来","以后想做什么","高数"],answer:"现阶段的主线是三件事：高数、英语和 AI。高数是必修的地基，英语是为将来出国读书打底，AI 应用则是想一直做下去的方向——先把这三样学扎实，再谈别的。",followups:["你最近在做什么？","网站还会更新吗？","你的学习经历是怎样的？"]},
{id:"english",ask:"你为什么学英语？",keys:["为什么学英语","英语","背单词","四级","六级","外语","english"],answer:"为将来出国读书打底：最好的文档、最新的论文、最好玩的项目说明大多是英文写的，练到能直接读一手资料、自己走出去，就不用等别人转述了。",followups:["你最近在做什么？","你接下来打算做什么？","你的技能怎么样？"]},
...
/* ---------- 闲聊与玩梗 ---------- */
{id:"code",ask:"你会做什么？",keys:["你会什么","你会做什么","你会干啥","能做什么","能帮我什么","有什么功能","你能干嘛","你能做什么"],answer:"我能用崇施涵的小抄回答你：他的学习、方向、经历、作品、兴趣、联系方式，以及这站是怎么做的。超出这个范围的，我只能说「这个得问他本人」。",followups:["你是谁？","你最近在做什么？","怎么联系你？"]},
...
{id:"mood",ask:"你今天心情如何？",keys:["心情","开心吗","快乐吗","今天怎么样","状态怎么样"],answer:"我今天状态挺好：没有报错、没有未读邮件。真人的情绪我不敢代答，但主页能从 V1 活到 V4，他应该不算太差。",followups:["你最近在做什么？","你有什么兴趣？","你是谁？"]},
...
{id:"weather",ask:"今天天气怎么样？",keys:["天气","下雨","温度","冷不冷","热不热","几点","现在几点"],answer:"我查不了天气，也看不了表——毕竟我只是一页不联网的本地 JavaScript。想知道深圳今天冷不冷，问真人或者手机更靠谱。",followups:["你在哪个城市？","你是谁？","你会做什么？"]},
...
{id:"recsong",ask:"给我推荐首歌吧",keys:["推荐首歌","推荐歌","推荐一首","来首歌","推荐音乐","听什么好","推荐点音乐"],answer:"口味参考：纯音乐、国语、日语、粤语都能听，安静抒情的优先。要是懒得挑，先点右下角放那首——反正是他自己写的，不满意也没法给差评。",followups:["背景音乐是哪来的？","你喜欢听什么音乐？","你有什么兴趣？"]},
...
(function initLightbox(){const imgs=[...document.querySelectorAll(".petal img")];if(!imgs.length)return;let index=0;const overlay=document.createElement("div"),image=document.createElement("img"),close=document.createElement("button"),prev=document.createElement("button"),next=document.createElement("button"),counter=document.createElement("span");overlay.className="lightbox";close.className="lb-close";close.textContent="×";close.setAttribute("aria-label","关闭");prev.className="lb-prev";prev.textContent="‹";prev.setAttribute("aria-label","上一张");next.className="lb-next";next.textContent="›";next.setAttribute("aria-label","下一张");counter.className="lb-count";overlay.append(image,close,prev,next,counter);document.body.appendChild(overlay);const render=()=>{const img=imgs[index];const tok=String(index)+"|"+(img.currentSrc||img.src);image.dataset.tok=tok;image.src=img.currentSrc||img.src;image.alt=img.alt;counter.textContent="载入中… "+(index+1)+" / "+imgs.length;const seq=[img.dataset.hi,img.dataset.view].filter(Boolean);let k=0;const step=()=>{if(k>=seq.length){counter.textContent=(index+1)+" / "+imgs.length;const c=navigator.connection||{};if(c.saveData||/(^|-)2g$/.test(c.effectiveType||""))return;const full=img.dataset.full;if(!full)return;const big=new Image();big.onload=()=>{if(image.dataset.tok===tok&&big.naturalWidth>image.naturalWidth*1.2)image.src=full};big.src=full;return}const url=seq[k++];const t=new Image();t.onload=()=>{if(image.dataset.tok!==tok)return;image.src=url;step()};t.onerror=()=>{if(image.dataset.tok===tok)step()};t.src=url};step()};const show=i=>{index=(i+imgs.length)%imgs.length;render()};const hide=()=>overlay.classList.remove("is-open");imgs.forEach((img,i)=>img.addEventListener("click",()=>{show(i);overlay.classList.add("is-open")}));prev.addEventListener("click",e=>{e.stopPropagation();show(index-1)});next.addEventListener("click",e=>{e.stopPropagation();show(index+1)});close.addEventListener("click",hide);overlay.addEventListener("click",e=>{if(e.target===overlay)hide()});document.addEventListener("keydown",e=>{if(!overlay.classList.contains("is-open"))return;if(e.key==="Escape")hide();if(e.key==="ArrowLeft")show(index-1);if(e.key==="ArrowRight")show(index+1)})})();
